	...
	return (
		<div className="h-screen">
			...
			<div className="h-96 my-8">
				...
				<p className="text-sm font-thin text-center mb-4">
					the names were provided by our lovely classmates Samuel K.
					and Fin W.
				</p>
			...
			<div className="h-[48rem] grid grid-cols-2 grid-rows-2 font-light">
				...
				<div className="text-center flex flex-col justify-center items-center h-full">
					...
					<p className="w-2/3 mb-4 text-lg">
						either shoot us an email at the address shown below or
						give us a phone call. we&apos;ll try our best to save
						you a spot with us.
					</p>
					<div className="flex items-center gap-4">
						...
						<a href="mailto:acme@company.com">acme@company.com</a>
					</div>
